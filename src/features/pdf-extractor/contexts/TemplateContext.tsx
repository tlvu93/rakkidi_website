...
export interface TemplateContextProps {
  ...
  updateTemplate: (newTemplate: Partial<PDFExtractTemplate>) => void;
...
export const TemplateProvider: React.FC<TemplateProviderProps> = ({
  ...
  const [template, setTemplate] = useState<PDFExtractTemplate>(
    initialTemplate ?? {
      name: 'New Template',
      description: '',
      extractionFields: []
  ...
  const updateTemplate = (newTemplate: Partial<PDFExtractTemplate>): void => {
    setTemplate((prevTemplate) => ({
      ...prevTemplate,
      ...newTemplate
    }));
  ...
  const importTemplate = async (
    ...
    try {
      ...
      const importedTemplate = JSON.parse(text) as PDFExtractTemplate;
